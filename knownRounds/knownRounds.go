...
func (kr *KnownRounds) RangeUncheckedMasked(mask *KnownRounds,
	...
	jww.DEBUG.Printf("if %v", mask.firstUnchecked != mask.lastChecked)
	if mask.firstUnchecked != mask.lastChecked {
		mask.Forward(kr.firstUnchecked)
		jww.DEBUG.Printf("*** MASK 1:")
		jww.DEBUG.Printf("***     firstUnchecked: %d", mask.firstUnchecked)
		jww.DEBUG.Printf("***     lastChecked:    %d", mask.lastChecked)
		jww.DEBUG.Printf("***     fuPos:          %d", mask.fuPos)
		jww.DEBUG.Printf("***     bitStream:      %064b", mask.bitStream)
		subSample, delta := kr.subSample(mask.firstUnchecked, mask.lastChecked)
		jww.DEBUG.Printf("*** SUBSAMPLE:")
		jww.DEBUG.Printf("***     bitStream: %064b", subSample)
		jww.DEBUG.Printf("***     delta:     %d", delta)
		jww.DEBUG.Printf("*** MASK 2:")
		jww.DEBUG.Printf("***     firstUnchecked: %d", mask.firstUnchecked)
		jww.DEBUG.Printf("***     lastChecked:    %d", mask.lastChecked)
		jww.DEBUG.Printf("***     fuPos:          %d", mask.fuPos)
		jww.DEBUG.Printf("***     bitStream:      %064b", mask.bitStream)
		jww.DEBUG.Printf("*** KNOWN ROUNDS:")
		jww.DEBUG.Printf("***     firstUnchecked: %d", kr.firstUnchecked)
		jww.DEBUG.Printf("***     lastChecked:    %d", kr.lastChecked)
		jww.DEBUG.Printf("***     fuPos:          %d", kr.fuPos)
		jww.DEBUG.Printf("***     bitStream:      %064b", kr.bitStream)
